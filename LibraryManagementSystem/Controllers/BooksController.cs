...
namespace LibraryManagementSystem.Controllers
{
    public class BooksController : Controller
    {
        ...
        public BooksController(Library_Management_SystemContext context)
        {
            _context = context;
        }
        ...
        {
            var library_Management_SystemContext = _context.Books.Include(b => b.Author).Include(b => b.Publisher);
